package com.example.android.clipping
...
class ClippedView @JvmOverloads constructor(
    ...
    private val paint = Paint().apply {
        //Smooth out the edges of what is being drawn without affecting shape
        isAntiAlias = true
    ...
    private val columnTwo = columnOne + rectInset + clipRectLeft
    ...
    private fun drawClippedectangle(canvas: Canvas){
